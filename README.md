...
Declarative package management for Arch Linux. Define the desired state of installed packages in a set of TOML files, and `pkgstate` will ensure that
...
1. Inside that directory, create one or more TOML files defining the desired state of your system. If there are multiple files, they will be merged together.
    ```toml
